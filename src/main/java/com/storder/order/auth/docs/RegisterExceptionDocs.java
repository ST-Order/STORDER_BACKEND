...
public class RegisterExceptionDocs implements SwaggerExampleExceptions {
	...
	@ExplainError
	public GlobalCodeException 비밀번호_형식_에러 = new AuthException(NOT_VALID_PASSWORD);

	@ExplainError
	public GlobalCodeException 비밀번호_확인_에러 = new AuthException(NOT_EQUAL_PASSWORD_AND_PASSWORD_CHECK);
