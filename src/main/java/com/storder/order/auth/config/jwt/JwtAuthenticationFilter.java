...
public class JwtAuthenticationFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
            throws JwtException, IOException, ServletException {
        ...
        try {
            ...
            setErrorResponse(
                    (HttpServletResponse) response, "만료된 토큰입니다..", HttpStatus.UNAUTHORIZED);
            return;
            ...
            setErrorResponse(
                    (HttpServletResponse) response, "토큰이 존재하지 않습니다.", HttpStatus.UNAUTHORIZED);
            return;
        }
