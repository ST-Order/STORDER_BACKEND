...
public class JwtTokenProvider {
    ...
    public AuthResponseDto.TokenInfo generateToken(Authentication authentication, String name) {
        ...
        LocalDateTime accessTokenExpiration =
                LocalDateTime.now().plusDays(ACCESS_TOKEN_EXPIRATION_TIME);
        LocalDateTime refreshTokenExpiration =
                LocalDateTime.now().plusDays(REFRESH_TOKEN_EXPIRATION_TIME);

        return AuthResponseDto.TokenInfo.create(
                name, accessToken, refreshToken, accessTokenExpiration, refreshTokenExpiration);
    }
