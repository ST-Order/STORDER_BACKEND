...
public class OrderSummaryDto {
	...
	public OrderSummaryDto(Long orderId, LocalDateTime createdAt, String storeImage, String storeName, Long totalOrderPrice, LocalDateTime endAt) {
		this.orderId = orderId;
		this.orderDate = createdAt.toLocalDate(); // LocalDate로 변환
		this.storeImage = storeImage;
		this.storeName = storeName;
		this.totalOrderPrice = totalOrderPrice != null ? totalOrderPrice : 0L; // Long 타입 변환 및 null 방지
		this.endAt = endAt;
	}
}
