...
@ExceptionDoc
public class PopularMenuExceptionDocs implements SwaggerExampleExceptions {
    ...
    @ExplainError
    public GlobalCodeException 인기_메뉴_존재하지_않음 = new MenuException(MenuErrorCode.POPULAR_MENU_NOT_FOUND);
}
