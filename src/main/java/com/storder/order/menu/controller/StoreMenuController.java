...
public class StoreMenuController {
    ...
    @GetMapping
    public ApiResponse<MenuResponseDto> getAllMenus() {
    ...
    @PostMapping
    public ApiResponse<Void> createMenu(@RequestBody MenuRequestDto menuRequestDto) {
        return ApiResponse.success("메뉴 등록에 성공하였습니다.", null);
    }
    ...
    public ApiResponse<Void> deleteMenu(
        ...
        return ApiResponse.success("메뉴 삭제에 성공하였습니다.", null);
    }
    ...
    public ApiResponse<SoldOutMenuResponseDto> getSoldOutMenus() {
        ...
        return ApiResponse.success(
                "품절 메뉴 조회에 성공하였습니다.", SoldOutMenuResponseDto.builder().menus(menus).build());
    }
}
